...
import { Plus, Play, Trash2, Edit, Copy, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mb-10">
          <h2 className="mb-4 font-display text-xl font-bold text-foreground">Kvízeim</h2>
          {quizzes.length === 0 ? (
            <Card>
              <CardContent className="py-10 text-center">
                <p className="text-muted-foreground">Még nincsenek kvízeid. Hozd létre az elsőt!</p>
